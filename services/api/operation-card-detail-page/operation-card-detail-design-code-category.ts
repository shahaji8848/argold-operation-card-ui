...
const GETProductProcessDesignCodeCategory = async (product: any, token: any) => {
  ...
  const url = `${CONSTANTS.API_BASE_URL}${CONSTANTS.STANDARD_API_PATH}/Design Code Category?fields=${JSON.stringify(
    fields

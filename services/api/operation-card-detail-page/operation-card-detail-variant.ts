...
const GETOperationCardDetailProcessVariant = async (product: any, token: any) => {
  ...
  const url = `${CONSTANTS.API_BASE_URL}${CONSTANTS.STANDARD_API_PATH}/Variant?fields=${JSON.stringify(
    fields
